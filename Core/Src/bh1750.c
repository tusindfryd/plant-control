...
void BH1750_Init(BH1750_HandleTypeDef *hbh1750) {
	...
	HAL_I2C_Master_Transmit(hbh1750->I2C, hbh1750->Address, &command,
			BH1750_COMMAND_SIZE, hbh1750->Timeout);
...
float BH1750_ReadIlluminance_lux(BH1750_HandleTypeDef *hbh1750) {
	...
	HAL_I2C_Master_Receive(hbh1750->I2C, hbh1750->Address, rxarray,
			BH1750_DATA_SIZE, hbh1750->Timeout);
